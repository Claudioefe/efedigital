...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a] pt-32"
    >
        ...
        >
          ...
          >
            ...
            <span className="text-[var(--neon-green)] text-sm">
              Expertos en WordPress, WooCommerce & Automatizaciones
            </span>
          </motion.div>
          ...
          >
            Fusionamos <span className="text-white/80">Desarrollo Web</span>,{" "}
            <span className="text-white/80">Automatización</span> e{" "}
            <span className="text-white/80">Inteligencia Artificial</span> para
            que tu negocio venda, gestione y escale mientras tú te ocupas de lo
            importante.
          </motion.p>
          ...
          >
            <AnimatedButton
              ...
              ariaLabel="Ver nuestras soluciones y servicios"
            >
              Ver Soluciones
            </AnimatedButton>
            ...
            <AnimatedButton
              ...
              ariaLabel="Contactarnos para hablar sobre tu proyecto"
            >
              Hablemos
            </AnimatedButton>
          </motion.div>
          ...
          >
            {["WordPress", "WooCommerce", "n8n", "AI/LLM", "React"].map(
              (tech) => (
                <motion.div
                  key={tech}
